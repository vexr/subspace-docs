...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-ubuntu-x86_64-skylake-mainnet-2026-mar-09"
    title="Node Executable"
    subtitle="(Skylake+ CPU)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09"
...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-ubuntu-x86_64-v2-mainnet-2026-mar-09"
    title="Node Executable"
    subtitle="(Legacy CPU)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-ubuntu-x86_64-v2-mainnet-2026-mar-09"
    title="Farmer Executable"
    subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
<ReleaseContainer>
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-ubuntu-aarch64-mainnet-2026-mar-09"
    title="Node Executable"
    subtitle="(Aarch64/Raspberry Pi)" />
  <ReleaseButton
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-ubuntu-aarch64-mainnet-2026-mar-09"
    title="Farmer Executable"
    subtitle="(Aarch64/Raspberry Pi)" />
</ReleaseContainer>
...
```bash
chmod +x subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09
chmod +x subspace-node-ubuntu-x86_64-skylake-mainnet-2026-mar-09
```
...
```bash
./subspace-node-ubuntu-x86_64-skylake-mainnet-2026-mar-09 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --name "<NAME>" \
...
4. You should see output similar to this in the terminal:
```text
...
:::tip Farm Location Guidance

To avoid running out of space on your operating system or node database drive, it's recommended to store your farms on a separate drive. 
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 farm \
