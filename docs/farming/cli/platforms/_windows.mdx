...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-windows-x86_64-skylake-mainnet-2026-mar-09.exe" 
    title="Node Executable" 
    subtitle="(Skylake+ CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-windows-x86_64-skylake-mainnet-2026-mar-09.exe" 
...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-windows-x86_64-v2-mainnet-2026-mar-09.exe" 
    title="Node Executable" 
    subtitle="(Legacy CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-windows-x86_64-v2-mainnet-2026-mar-09.exe" 
    title="Farmer Executable" 
    subtitle="(Legacy CPU)" />
</ReleaseContainer>
...
```powershell
.\subspace-node-windows-x86_64-skylake-mainnet-2026-mar-09.exe `
  run `
  --chain mainnet `
  --base-path "<BASE_PATH>" `
  --farmer `
...
```PowerShell
.\subspace-farmer-windows-x86_64-skylake-mainnet-2026-mar-09.exe farm --reward-address "<REWARD_ADDRESS>" path="<PATH_TO_FARM>,size=<FARM_SIZE>"
```
