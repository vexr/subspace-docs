...
<ReleaseContainer>
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-node-macos-aarch64-mainnet-2026-mar-09.zip" 
    title="Node Executable" 
    subtitle="(Apple CPU)" />
  <ReleaseButton 
    to="https://github.com/autonomys/subspace/releases/download/mainnet-2026-mar-09/subspace-farmer-macos-aarch64-mainnet-2026-mar-09.zip" 
...
After this, simply repeat the step you prompted for. This time, click the `Open` button when prompted.
...
- `chmod +x subspace-farmer-macos-aarch64-mainnet-2026-mar-09`
- `chmod +x subspace-node-macos-aarch64-mainnet-2026-mar-09`
...
```bash
./subspace-node-macos-aarch64-mainnet-2026-mar-09 \
  run \
  --chain mainnet \
  --base-path "<BASE_PATH>" \
  --farmer \
...
```bash
./subspace-farmer-macos-aarch64-mainnet-2026-mar-09 farm --reward-address \"<REWARD_ADDRESS>\" path=\"<PATH_TO_FARM>,size=<FARM_SIZE>\"
```
