...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 wipe <PATH_TO_FARM>
./subspace-node-ubuntu-x86_64-skylake-mainnet-2026-mar-09 wipe <BASE_PATH>
```
...
```bash
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 farm --reward-address "<REWARD_ADDRESS>" \
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 benchmark audit <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 benchmark prove <PATH_TO_FARM>
```
...
```
./subspace-farmer-ubuntu-x86_64-skylake-mainnet-2026-mar-09 scrub <PATH_TO_FARM>
```
